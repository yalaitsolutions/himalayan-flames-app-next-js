        ...
        <div className="container">
          <div className="story-grid">
            ...
            <div className="story-text reveal-right">
              ...
              <Link to="/menu" className="btn btn-gold"><i className="fas fa-book-open"></i> Explore Our Menu</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="about-cta">
        <div className="container">
          ...
          <div className="about-cta-btns">
            <Link to="/menu" className="btn btn-gold"><i className="fas fa-utensils"></i> View Our Menu</Link>
            <Link to="/contact" className="btn btn-outline"><i className="fas fa-map-marker-alt"></i> Find Us</Link>
