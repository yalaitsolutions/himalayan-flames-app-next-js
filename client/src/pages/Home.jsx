...
export default function Home() {
  ...
  useEffect(() => { getReviews().then((d) => setReviews(d.reviews)).catch(() => {}); }, []);
  usePageEffects([reviews.length]);
      ...
      <section className="hero">
        ...
        <div className="container hero-content">
          ...
          <div className="hero-cta">
            <Link to="/menu" className="btn btn-gold"><i className="fas fa-utensils"></i> View Menu</Link>
            <a href={CLOVER} target="_blank" rel="noreferrer" className="btn btn-red"><i className="fas fa-shopping-bag"></i> Order Online</a>
            <Link to="/contact" className="btn btn-outline"><i className="fas fa-map-marker-alt"></i> Contact Us</Link>
          </div>
        </div>
      ...
      <section className="dishes-section section">
        <div className="container">
          ...
          <div style={{ textAlign: "center", marginTop: "3rem" }}>
            <Link to="/menu" className="btn btn-outline"><i className="fas fa-book-open"></i> Explore Full Menu</Link>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="why-grid">
            ...
            <div className="reveal-right">
              ...
              <Link to="/about" className="btn btn-gold"><i className="fas fa-info-circle"></i> Our Story</Link>
            </div>
          </div>
        </div>
      </section>
